<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Group5_CPRG214_Lab2._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <img class="container" src="Images/inlandmarina_banner.jpg" />
    <div class="jumbotron">
        <h1 class="Justify-content-center">Welcome to Inland Marina</h1>
    </div>

    <div class="row ml-1">
        <p>Welcome to Inland Marina located on the south shore Inland Lake, just a small commute from major centers in the south west.</p>
